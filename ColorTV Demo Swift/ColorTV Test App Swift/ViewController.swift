...
class ViewController: UIViewController {
  ...
  @IBOutlet weak var contentRecButton: UIButton!
  
  @IBOutlet weak var jk: UIButton!
  var buttons: [UIButton] {
    var stack = (stackView.subviews as! [UIButton])
    stack.append(contentRecButton)
    return stack
  }
  ...
  override func viewDidLoad() {
    ...
    buttons.forEach { $0.layer.cornerRadius = 8.0 }
  ...
  @IBAction func showContentRecomendation(_ sender: Any) {
    let demoVideoURL = URL(string: "https://s3.amazonaws.com/colortv-testapp-data/0017.mp4")!
    
    let vvc = UIStoryboard(name: "Video", bundle: nil).instantiateInitialViewController()! as! VideoViewController
    vvc.loadVideo(with: demoVideoURL, identifier: "0017")
